        ...
        ton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                db.execSQL("'update biodata set name='" +
                        text2.getText().toString() + "', dob='" + text3.getText().toString() + "', gender='" + text4.getText().toString() + "', address='" + text5.getText().toString() + "', where no='" + text1.getText().toString() + "'");
